...
Every rule that matters is stated on this page. If you want the alternatives a
rule was chosen over, the repository's [Architecture Decision
Records](https://github.com/willdady/platypus/tree/main/docs/adr) are the
maintainers' working record; they are not part of these docs and can lag the
code.
...
records the rejected open-contract alternative.)
...
records the rejected copy-on-share and implicit-cascade alternatives.)
