...
Platypus 2.0 introduces the
[plugin system](/extending/plugin-api-and-config#the-plugin-model): the
...
- [Extending → Your first plugin](/extending/your-first-plugin) — writing your
  own plugins against
