...
In your Workspace, go to **Settings → MCP** and click **Add MCP**.
...
An MCP has **no Promote action** — unlike an Agent or a Skill, it can't be
re-scoped after the fact. An Org Admin creates it at Organization scope in the
first place, under **Organization settings → MCP → Add MCP**. If you already
registered one in your Workspace and now want it shared, it has to be created
again at the Organization level.
