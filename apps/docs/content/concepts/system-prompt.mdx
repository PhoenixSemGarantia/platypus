...
| **7**  | **Memories**              | When there are Memories to recall               | The [Memory](/concepts/memory-and-context#memory) summaries retrieved for you in this Workspace. Fixed for the life of an active Chat, and refreshed on the next message after an hour of no activity — not re-retrieved every turn. |
